...
import com.mystudy.Project_shop.dao.AdminProductDAO;
import com.mystudy.Project_shop.vo.AdminProductVO;
...
public class AdminProductAddCommand implements AdminCommand{
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path = "c:/MyStudy/60_Web/Project_shop_2/WebContent/image";
		...
		return "admin?type=admin-product";
	}
