...
import com.mystudy.paging.Paging;
...
public class revSearchCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 게시물 수량 구하기
		pp.setTotalRecord(CommunityShopDAO.revSearchCount(map));
		pp.setTotalPage();
		...
		List<qnaVO> list = CommunityShopDAO.revSearch(pmap);
