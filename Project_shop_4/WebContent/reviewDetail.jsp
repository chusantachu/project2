      	...
      	<th colspan="2">
				...
				<c:when test="${loginUserId eq vo.id}">
					<div style=" text-align: center;">
						...
						<button type="submit" class="btn btn-dark" style=" display: inline-block;">목록</button>
						<input type="hidden" name="bNum" value="${vo.bNum}">
						<input type="hidden" name="type" value="reviewFinal">
...
<%-- 				<td style="text-align: center;">${vo.content }</td>  --%>
<%-- 				<td style="text-align: center;" >${vo.cDate.substring(0,10) }</td>  --%>
<%-- 				<c:if test="${loginUserId eq vo.id}"> --%>
<!-- 					<td style="text-align: center;"> -->
<%-- 						<button type="button" class="btn btn-dark" onclick='location.href="bord?type=admin-commentDelete&cNum=${vo.cNum}&bNum=${vo.bNum}&cPage=${cPage}"'>삭제</button> --%>
<!-- 					 </td>  -->
<%-- 				 </c:if> --%>
