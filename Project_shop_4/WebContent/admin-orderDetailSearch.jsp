...
<script>
	function list_go() {
 		location.href = "admin?type=admin-orderList&cPage=${cPage}&select=${select}&keyword=${keyword}";
	}
</script>
<style>
...
<div class="container">
  ...
  <tbody>
   <tr>
      ...
      <tr>
      	<th colspan = "2" style="color: red;">* (수정예정) 아래 a태그 상품상세보기 연결로 수정해야함 *</th>
      </tr>
      ...
      <tr>
	      ...
	      <c:forEach var="vo" items="${list }">
		       <!-- 상세페이지랑 연결할 것 (수정예정) -->
		       <a href="product.jsp"> ${vo.productName}-${vo.model} (${vo.cCount}개)</a><br>
	      </c:forEach>
	      </td>
	     </tr>
      <tr>
