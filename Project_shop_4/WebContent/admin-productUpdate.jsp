...
<%@page import="com.mystudy.Project_shop.vo.AdminProductVO"%>
...
<script>
	...
	function list_go() {
 		location.href = "admin?type=admin-product&cPage=${cPage}";
	}
</script>
<style>
	table {
...
<div>
	<form action="admin?type=admin-productUpdate" method="post" enctype="multipart/form-data">
	<table>
		<tbody>
			<tr>
				<th>카테고리</th>
			...
			<tr>
				<th>이미지파일</th>
				<td>
					<input type="file" name="image" title="이미지파일" vlaue="${vo.image}">
				</td>
			</tr>
			<tr>
				<th>상세설명</th>
