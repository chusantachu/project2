...
<script>
	...
	function orderlist() {
		location.href = "controller?type=orderList&id=${id}";
	}
	
	function cart() {
		location.href = "controller?type=cart&id=${id}";
	}
...
<table class="table table-striped w-auto">
 ...
 <%-- <form action="controller" method="get">  --%>
  	...
  	<input type="button" class="btn btn-dark" value="장바구니" onclick="cart()">
  	<input type="button" class="btn btn-dark" value="게시글 관리" onclick="board()">
