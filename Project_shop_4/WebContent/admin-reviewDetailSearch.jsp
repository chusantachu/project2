      ...
      <c:if test="${not empty list }"> 
       <c:forEach var="vo" items="${list }"> 
 	      <tr> 
 	        ...
 	        <td style="text-align: center;">
 	        	<button type="button" class="btn btn-dark" onclick='location.href="admin?type=admin-commentDeleteSearch&cNum=${vo.cNum}&bNum=${vo.bNum}&cPage=${cPage}&select=${select}&keyword=${keyword}"'>삭제</button>
 	        </td> 
 	      </tr> 
       </c:forEach>
       </c:if> 
